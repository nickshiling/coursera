...
public class Point implements Comparable<Point> {
    ...
    private static class BySlope implements Comparator<Point> {
        ...
        public BySlope(Point currentPoint) {
    ...
    public double slopeTo(Point that) {
        ...
        double xComponent = that.x - this.x;
        double yComponent = that.y - this.y;

        if (xComponent == 0) { return Double.POSITIVE_INFINITY; }
        if (yComponent == 0) { return 0.0; }
